...
if (verify) {
  ...
  var birthdayNotify = function () {
    ...
    for (var i = 0; i < dataSource.length; i++) {
      ...
      var solarData = calendar.lunar2solar(params.year, params.month, params.day, params.isLeapMonth);
      var physiologicalDay=getPhysiological(data.physiologicalDefault, data.physiologicalCycle, i);
      $.log(solarData);
      birthdayMessage += `
[${data.username}]
    🐣破壳日：
