...
# 获取方式:访问https://youyun666.com/ 首次手动签到


hostname=youyun666.com;

[task_local]
1 0 * * * https://raw.githubusercontent.com/dompling/Script/master/youyun/youyun.js

(1). Quantumult X
[rewrite_local]
https:\/\/youyun666.com\/user\/checkin url script-request-header https://raw.githubusercontent.com/dompling/Script/master/youyun/youyun.cookie.js

(2). Loon
[Script]
http-request https:\/\/youyun666.com\/user\/checkin script-path=https://raw.githubusercontent.com/dompling/Script/master/youyun/youyun.cookie.js, require-body=false

(3). Surge
[Script]
type=http-request, pattern=https:\/\/youyun666.com\/user\/checkin, script-path=https://raw.githubusercontent.com/dompling/Script/master/youyun/youyun.cookie.js, require-body=false

 */

const $ = new API("youyun", true);
const cookie = $.read("cookie"); // 登陆 Cookie
const baseUrl = "https://youyun666.com/";
